...
class FetchWeightEnv(robot_env.RobotEnv):
    ...
    def __init__(
        ...
        super(FetchWeightEnv, self).__init__(
    ...
    def _is_success(self, achieved_goal, desired_goal):
        ...
        d_all = goal_distance(achieved_goal, desired_goal)
        return (d < self.distance_threshold).astype(np.float32)
    ...
    def render(self, mode='human', width=500, height=500):
        return super(FetchWeightEnv, self).render(mode, width, height)
