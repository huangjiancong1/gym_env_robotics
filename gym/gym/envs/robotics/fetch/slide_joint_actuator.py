...
MODEL_XML_PATH = os.path.join('fetch', 'slide_joint_actuator.xml')


class FetchSlideJointActuatorEnv(fetch_joint_actuator_env.FetchJointActuatorEnv, utils.EzPickle):
