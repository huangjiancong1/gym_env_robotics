...
class RolloutWorker:
    ...
    @store_args
    def __init__(self, env_name, make_env, policy, dims, logger, T, rollout_batch_size=1,
                 exploit=False, use_target_net=False, compute_Q=False, noise_eps=0,
                 random_eps=0, history_len=100, render=False, n_rsym=None, **kwargs):
        ...
        self.clear_history()
        self.n_rsym = n_rsym #--------------------------------------------sym
        self.mirror = mirror_learning(env_name,n_rsym) #-----------------------------------sym
